// ==UserScript==
// @name Krunker SkidFest - 日本語(Ja)
// @description フル機能のハック
// @version 1.97
    ...
    constructor(script) {
        ...
        this.lists = {
            ...
            autoBhop: {
                off: "オフ",
                autoJump: "オートジャンプ",
                keyJump: "スペースキーを押してジャンプ",
                autoSlide: "オートスライド",
                keySlide: "スペースキーを押してスライド"
            },
            autoAim: {
                off: "オフ",
                correction: "照準の自動修正",
            ...
            audioStreams: {
                off: '無し',
                _2000s: '\'00年代',
                _HipHopRNB: 'ヒップホップ(RNB)',
                _Oldskool: 'ヒップホップ(Oldskool)',
                _Country: 'カントリー',
                _Pop: 'ポップ',
                _Dance: 'ダンス',
                _Dubstep: 'ダブステップ',
    ...
    createSettings() {
        this.settings = {
            ...
            customCSS: {
                name: "カスタムCSS",
                val: "",
                html: () => this.generateSetting("url", "customCSS", "URLをペーストして下さい"),
            ...
            autoReload: {
                pre: "<br><div class='setHed'>武器設定</div>",
                name: "自動リロード",
                val: false,
            ...
            autoBhop: {
                pre: "<br><div class='setHed'>プレイヤーの設定</div>",
                name: "自動ジャンプ",
                val: "off",
            ...
            disableWpnSnd: {
                pre: "<br><div class='setHed'>ゲーム設定</div>",
                name: "武器の音を無効化",
                val: false,
            ...
            playStream: {
                pre: "<br><div class='setHed'>音楽を流す</div>",
                name: "種類",
                val: "off",
...
*/
        ...
        let waitForWindows = setInterval(_ => {
            if (window.windows) {
                ...
                menu.gen = _ => {
                    var tmpHTML = `<div style='text-align:center'> <a onclick='window.open("https://skidlamer.github.io/")' class='menuLink'>SkidFestの設定画面</center></a> <hr> </div>`;
                    ...
                    tmpHTML += `<br><hr><a onclick='window.utilities.resetSettings()' class='menuLink'>設定をリセット</a> | <a onclick='window.utilities.saveScript()' class='menuLink'>設定を保存</a>`
    ...
    resetSettings() {
        if (confirm("すべての設定をリセットしてもよろしいですか？ これにより、ページも更新されます。")) {
